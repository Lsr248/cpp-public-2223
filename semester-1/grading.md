...
Для каждой дорешки формируется два дедлайна:
 - `BONUS_DEADLINE` -- третий день после выдачи дорешки в 23:59 (если дорешка выдана во вторник, то дедлайн следующую пятницу 23:59)
 - `DEADLINE` -- день следующего семинара в 18:00

Задача считается решенной, если все тесты на CI пройдены.

Если решенить все базовые задачи к `BONUS_DEADLINE`, то будет начислен бонус `0.5`.
